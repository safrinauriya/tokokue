    ...
    <div class="row no-gutters">
        <div class="col-md-2 mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="tampilantransaksi.php">Data Pembeli</a><hr class="bg-secondary">
                </li>
              </ul>
        </div>
        ...
        <tbody>
           ...
           while($data = mysqli_fetch_array($sql)){
               ...
               echo"<td><a href='delete_pembeli.php?id_pembeli".$data['id_pembeli']."'class='btn btn-danger' onclick='return confirm(\"Apakah anda yakin ingin menghapus data?\")'>Hapus Data</a></td>";
               echo "</tr>";
}
?>
