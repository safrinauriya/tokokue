...
<form method="GET" action="create_stok.php">
		...
		<center><h1>PEMESANAN KUE</h1></center>
		<hr>
        ...
        <div class="form-group">
			...
			<label>Jumlah</label>
				<td><input type="text" name="jumlah" class="form-control" placeholder="Masukkan Jumlah"></td>
        </div>

				<button type="submit" value="LOGIN" class="btn btn-primary">PESAN</button>
